...
/*
    ...
    Updated: 2024-01-24
	Author URI: https://github.com/whywilson/dianxiaomi-for-woocommerce/releases/tag/Released
...
<?php
            ...
            private function display_order_dianxiaomi($order_id, $for_email)
            {
                ...
                if ($dianxiaomi_tracking_provider_name == '4PX Express' || $dianxiaomi_tracking_provider_name == '4PX') {
                    ...
                    echo $track_message_1 . $dianxiaomi_tracking_provider_name . '.<br/>' . $track_message_2 . '<a target="_blank" href="' . $dianxiaomi_tracking_number . '">' .  $custom_domain . $dianxiaomi_tracking_number . '</a>.' . $required_fields_msg;
                } else {
